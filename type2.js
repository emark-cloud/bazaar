...
async function invokeAgent() {
  ...
  const payload = encodeFunctionData({
    ...
    args: [/* key: string */, /* description: string */, /* min: uint256 */, /* max: uint256 */, /* prompt: string */, /* url: string */, /* resolveUrl: bool */, /* numPages: uint8 */, /* confidenceThreshold: uint8 */]
  });
  ...
  const result = decodeFunctionResult({ abi: agentMethodAbi, functionName: 'ExtractANumber', data: responseBytes });
